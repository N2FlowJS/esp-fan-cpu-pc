...
╚═══════════════════════╝
   │    │    │    │
  GND  12V  RPM  PWM
 (Black)(Yellow)(Green)(White/Green/Blue)
```
...
```c
#define WIFI_AP_SSID  "ESP32-Fan"  // Open AP - no password required
```

**Note:** The Access Point is **open network** (no password). To connect, simply select "ESP32-Fan" from available WiFi networks.
