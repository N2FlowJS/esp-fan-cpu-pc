...
const App = () => {
  const [activeTab, setActiveTab] = useState<'dash' | 'snif' | 'stress' | 'tools' | 'sys'>('dash');
  ...
  return (
    <div className="min-h-screen w-full bg-bg text-gray-200 selection:bg-accent/30 font-orbitron pb-10">
